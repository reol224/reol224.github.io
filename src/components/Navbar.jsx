          ...
          <navbar className="backdrop-filter backdrop-blur-lg bg-white bg-opacity-40 rounded-xl flex items-center justify-between shadow-md">
            ...
            <div className="justify-center">
              <a href={configData.hireMeLink}>
                <button
                  type="button"
                  className="border border-[#41a2e6] bg-[#41a2e6] text-white gap-x-1 before:ease relative overflow-hidden border border-[#000000] bg-[#050708] text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:before:-translate-x-40 font-medium rounded-lg text-sm px-2 py-2 text-center inline-flex items-center mx-7"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
