    ...
    <>
          ...
          <p>
            <ul>
              <li>
                ...
                {configData.aboutData[0].interests}
              </li>
              <li>
                <strong>What am I doing now? </strong>
                {configData.aboutData[0].now}
              </li>
              <li>
                <strong>Where am I from? </strong>
                {configData.aboutData[0].from}
              </li>
              <li
                className="tooltip"
              ...
              >
                <strong>Favourite painting: </strong>
                {configData.aboutData[0].favouritePainting}
                {showTooltip && (
                  <div className="tooltip-text">
                    <img
                      src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Baco%2C_por_Caravaggio.jpg/405px-Baco%2C_por_Caravaggio.jpg"
                      alt="Adolescent Bacchus"
                      width="200"
                    />
                  </div>
                )}
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="text-md font-normal text-gray-500 text-center px-3">
          I'm serious, do not let the computer win.
        </p>
      </div>
        ...
        <div className="flex flex-col gap-y-2">
          <div className="flex items-center text-center md:text-justify justify-center md:justify-normal">
            <a href={configData.hireMeLink}>
              <button
                type="button"
                className="border border-[#41a2e6] bg-[#41a2e6] text-white gap-x-1 before:ease relative overflow-hidden border border-[#000000] bg-[#050708] text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:before:-translate-x-40 font-medium rounded-lg text-sm px-2 py-2 text-center inline-flex items-center mr-2 mb-2"
              >
                <svg
